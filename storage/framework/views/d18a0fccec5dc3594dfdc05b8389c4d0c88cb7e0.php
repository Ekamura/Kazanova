<?php $__env->startSection('content'); ?>
    <section class="page-section equipment mt-lg-5" id="equipment">
        ...
        <main class="d-flex justify-content-center align-items-center mt-5">
            <form class="col col-md-8 col-lg-5 mt-5" method="post" action="<?php echo e(route('admin.AdminCheck')); ?>">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OpenServer\domains\Kazan\resources\views/admin/login.blade.php ENDPATH**/ ?>