            ...
            <div id="carousel" class="carousel carousel-dark slide text-center w-100" data-bs-ride="carousel">
                <div class="carousel-inner">
                        <div class="carousel-item text-center active">
                            ...
                            <img src="<?php echo e(asset('/storage/slide1.jpg')); ?>" class="d-block w-100 h-100"
                                 alt="asd"></a>
                            <div class="d-block">
                    ...
                    <div class="carousel-item text-center">
                        <a href="<?php echo e(route('catalog')); ?>">
                        <img src="<?php echo e(asset('/storage/slide2.jpg')); ?>" class="d-block w-100 h-100"
                             alt="asd" ></a>
                        <div class="d-block">
                            <h6 class="card-title pt-4"></h6>
                        </div>
                        ...
                        <a href="<?php echo e(route('catalog')); ?>">
                        <img src="<?php echo e(asset('/storage/slide3.jpg')); ?>" class="d-block w-100 h-100"
                             alt="asd" ></a>
                        <div class="d-block">
                            <h6 class="card-title pt-4"></h6>
                        </div>
        ...
        <div class="container">
            ...
            <div class="wedo">
                <div class="wedo__item">
                    <img class="wedo__img" src="<?php echo e(asset('/storage/all.jpg')); ?>" alt="">
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OpenServer\domains\Kazan\resources\views/welcome.blade.php ENDPATH**/ ?>