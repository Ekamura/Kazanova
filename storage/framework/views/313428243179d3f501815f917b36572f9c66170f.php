        ...
        <div class="col-xl-4">
            ...
            <div class="card mb-4 mb-xl-0">
                ...
                <div class="card-body text-center">
                    ...
                    <button class="btn btn-primary" type="button">Загрузить новую фотографию</button>
                </div>
            </div>
        </div>
        <div class="col-xl-8">
                    ...
                    <form>
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control" id="inputLastName" type="text" placeholder="Enter your last name" value="<?php echo e(Auth::user()->surname); ?>">
                            </div>
                        </div>
                        <div class="mb-3">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Kazan\resources\views/auth/profile.blade.php ENDPATH**/ ?>