...
<?php $__env->startSection('content'); ?>
    <div class="card offset-4 col-4 mt-5">
        ...
        <div class="card-body">
            <form class="" method="post" action="<?php echo e(route('register.store')); ?>">
                <?php echo csrf_field(); ?>
                <div class="input-group mb-3">
                    <span class="input-group-text">Имя</span>
                    <input type="text"
                           class="form-control <?php $__errorArgs = ['name_user'];
...
unset($__errorArgs, $__bag); ?>"
                           ...
                           name="name_user" aria-label="name_user" value="<?php echo e(old('name_user')); ?>">
                </div>
...
unset($__errorArgs, $__bag); ?>"
                           ...
                           name="phone" aria-label="phone" value="<?php echo e(old('phone')); ?>">
                </div>
...
unset($__errorArgs, $__bag); ?>"
                           ...
                           id="password_confirmation" value="<?php echo e(old('name')); ?>">
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Kazan\resources\views/auth/register.blade.php ENDPATH**/ ?>