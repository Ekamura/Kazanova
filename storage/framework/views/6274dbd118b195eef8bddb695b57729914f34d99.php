<?php $__env->startSection('content'); ?>
    <div class="d-flex justify-content-between align-items-start m-4">
        <a href="<?php echo e(route('admin.category.create')); ?>" class="btn btn-outline-secondary">
                ...
                <tr>
                    <td>
                        <button class="btn" data-bs-toggle="modal" data-bs-target="#modalCharacteristics"
                                onclick="outCharacteristicsModal(<?php echo e($specification); ?>)">
                            <?php echo e($specification->name); ?>

                        </button>
                    </td>
                    <td>
                        <form action="<?php echo e(route('admin.specification.destroy', $specification)); ?>" method="post">
                            <?php echo csrf_field(); ?>
...
<script>
    ...
    async function deleteCharacteristic(target, id) {
        ...
        let response = await fetch(`/admin/specification/delete/characteristics/${id}`,{
            method: "DELETE",
            body: JSON.stringify({id, '_token': '<?php echo e(csrf_token()); ?>'}),
            headers: {
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OpenServer\domains\Kazan\resources\views/specification/index.blade.php ENDPATH**/ ?>